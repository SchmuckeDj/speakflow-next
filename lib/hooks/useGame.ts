...
export const LEVELS = [
  ...
  { level: 3, label: "A2 — Presente", words: ["she works here", "he plays soccer", "they eat lunch", "I wake up early", "we take the bus", "do you like coffee", "I go to school", "she has a cat"], boss: "Do you speak English every day", speed: 0.50, spawnEvery: 120 },
  { level: 4, label: "A2 — Comparaciones", words: ["she is taller than me", "he runs faster", "it is more expensive", "this is the best", "my bag is bigger", "she is smarter than him"], boss: "She is much taller than her sister", speed: 0.58, spawnEvery: 115 },
  { level: 5, label: "B1 — Pasado simple", words: ["I went to the store", "she didn't come", "we had a meeting", "he forgot his keys", "they finished the work", "I called you yesterday"], boss: "I didn't understand what he said", speed: 0.65, spawnEvery: 110 },
  { level: 6, label: "B1 — Presente perfecto", words: ["I have finished", "she has never been", "we have just arrived", "have you ever tried", "I haven't seen him", "they have already left"], boss: "Have you ever traveled to another country", speed: 0.72, spawnEvery: 105 },
  { level: 7, label: "B2 — Condicionales", words: ["if I had more time", "I would help you", "she could have done it", "if it rains we stay", "I should have called", "he might be late"], boss: "If I had known I would have done it differently", speed: 0.80, spawnEvery: 100 },
  { level: 8, label: "B2 — Vocabulario", words: ["the deadline is tomorrow", "we need to prioritize", "let's collaborate on this", "the feedback was positive", "please implement the fix", "it's not scalable"], boss: "We need to leverage our resources more efficiently", speed: 0.88, spawnEvery: 95 },
  { level: 9, label: "C1 — Avanzado", words: ["the implications are nuanced", "ambiguous requirements", "a pragmatic approach", "it remains coherent", "the data is compelling", "she articulated it well"], boss: "The ambiguous phrasing led to a significant misunderstanding", speed: 0.96, spawnEvery: 88 },
  { level: 10, label: "C2 — Maestro", words: ["smartphones are ubiquitous", "an ephemeral experience", "a fundamental dichotomy", "an inextricable connection", "the paradigm has shifted", "a seminal contribution"], boss: "The ubiquitous nature of technology creates an inextricable dependency", speed: 1.10, spawnEvery: 80 },
];
